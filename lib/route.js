	...
	return function (req, res, next) {
		...
		switch (paths.length) {
			...
			case 3: /* request path: /api/modelName/1 */
				var idOrMeta = paths[2];
				if (idOrMeta == "$meta") {
					_this.handleResourceDescribe(req, res, Model);
					break;
				}
				var id = parseInt(idOrMeta);
				if (isNaN(id)) {
...
/* trims every single Property in Object */
